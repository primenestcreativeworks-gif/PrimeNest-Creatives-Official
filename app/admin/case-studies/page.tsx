  ...
  return (
    <div className="max-w-6xl">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white mb-2">Manage Case Studies</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Add, edit, or remove entries from your Recent Work section.</p>
        </div>
        <Link href="/admin/case-studies/new" className="px-4 py-2 bg-slate-800 hover:bg-slate-700 text-white dark:bg-white dark:text-[#040D1A] dark:hover:bg-slate-200 text-sm font-bold rounded-xl transition-colors shadow-sm inline-block">
          + Add New Project
        </Link>
      </div>
      ...
      <div className="bg-slate-50 dark:bg-[#07152B] border border-slate-200 dark:border-white/10 rounded-2xl overflow-hidden">
        {caseStudies.length === 0 ? (
          <div className="p-12 text-center flex flex-col items-center">
            ...
            <h3 className="text-lg font-medium text-slate-900 dark:text-white mb-2">No case studies found</h3>
            <p className="text-slate-500 dark:text-slate-400 max-w-sm mb-6">You either haven't added any yet, or your database connection is not configured.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-200 dark:border-white/10 bg-white/5">
                  ...
                  <th className="p-4 text-sm font-semibold text-slate-600 dark:text-slate-300">Headline</th>
                  <th className="p-4 text-sm font-semibold text-slate-600 dark:text-slate-300">Metric</th>
