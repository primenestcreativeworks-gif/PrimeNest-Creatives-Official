        ...
        <form action={createTestimonial} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input name="name" required className="w-full px-4 py-2 bg-[#050816] border border-white/10 rounded-xl text-white focus:outline-none focus:border-[#00AEEF]" placeholder="e.g. Nolan M." />
            </div>
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-2">Category (e.g. YouTube Creator)</label>
              <input name="role" required className="w-full px-4 py-2 bg-[#050816] border border-white/10 rounded-xl text-white focus:outline-none focus:border-[#00AEEF]" placeholder="e.g. YouTube Creator" />
            </div>
          </div>

          <div>
             <label className="block text-sm font-medium text-slate-300 mb-2">Job Title / Subtitle</label>
             <input name="title" required className="w-full px-4 py-2 bg-[#050816] border border-white/10 rounded-xl text-white focus:outline-none focus:border-[#00AEEF]" placeholder="e.g. Education Channel · 250K+ subs" />
          </div>

          <div>
             <label className="block text-sm font-medium text-slate-300 mb-2">Quote</label>
             <textarea name="quote" required rows={4} className="w-full px-4 py-2 bg-[#050816] border border-white/10 rounded-xl text-white focus:outline-none focus:border-[#00AEEF] resize-y" placeholder="PrimeNest took my messy raw footage..." />
          </div>
